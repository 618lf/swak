...
/**
 * This implementation wraps a {@link CallableStatement} and notifies a
...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
	...
	public static CallableStatement wrap(String sql, CallableStatement delegate, MetricsFactory metricsFactory) {
		if (delegate == null) {
			return null;
		}
		return new CallableStatementWrapper(sql, delegate, metricsFactory);
	}

	protected CallableStatementWrapper(String sql, CallableStatement delegate, MetricsFactory metricsFactory) {
		super(sql, delegate, metricsFactory);
