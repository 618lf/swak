...
/**
 * This implementation wraps a {@link StatementWrapper} and notifies a
...
public class StatementWrapper extends AbstractWrapper implements Statement {
	...
	public static Statement wrap(Statement delegate, MetricsFactory metricsFactory) {
		if (delegate == null) {
			return null;
		}
		return new StatementWrapper(delegate, metricsFactory);
	}

	protected StatementWrapper(Statement delegate, MetricsFactory metricsFactory) {
