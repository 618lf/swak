...
public class RefundNotifyResult extends MchBaseResult {
	...
	private String req_info;// 加密信息,需要做解密，暂时没做解密
	@XmlElement
	private Integer total_fee;//单位为分
	@XmlElement
	private Integer settlement_total_fee;//单位为分
	@XmlElement
	private Integer refund_fee;//单位为分
	@XmlElement
	private Integer settlement_refund_fee;//单位为分
	@XmlElement
	@XmlJavaTypeAdapter(value = CDataAdapter.class)
