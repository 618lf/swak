...
public class Expiration {
	 ...
	 *
	 * @param expirationTime can be {@literal null}. Defaulted to
	...
	/**
	 * Creates new {@link Expiration} with the provided {@link TimeUnit}. Greater
	 * units than {@link TimeUnit#SECONDS} are converted to
	 * {@link TimeUnit#SECONDS}. Units smaller than {@link TimeUnit#MILLISECONDS}
	 * are converted to {@link TimeUnit#MILLISECONDS} and can lose precision since
	 * {@link TimeUnit#MILLISECONDS} is the smallest granularity supported by Redis.
	 *
	 * @param expirationTime
	 * @param timeUnit       can be {@literal null}. Defaulted to
	 *                       {@link TimeUnit#SECONDS}
	 * @return
	 */
	...
	/**
	 * Creates new {@link Expiration} with the provided {@link java.time.Duration}.
	 * Durations with at least {@link TimeUnit#SECONDS} resolution use seconds,
	 * durations using milliseconds use {@link TimeUnit#MILLISECONDS} resolution.
	 *
