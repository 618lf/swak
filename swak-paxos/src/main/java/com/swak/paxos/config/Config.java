...
public class Config {
	...
	public boolean isLargeBufferMode() {
		return isLargeBufferMode;
	}

	public void setLargeBufferMode(boolean isLargeBufferMode) {
		this.isLargeBufferMode = isLargeBufferMode;
	}
	...
	public void setIMFollower(boolean isIMFollower) {
		this.isIMFollower = isIMFollower;
	}

	public long getFollowNodeID() {
		return followNodeID;
	}

	public void setFollowNodeID(long followNodeID) {
