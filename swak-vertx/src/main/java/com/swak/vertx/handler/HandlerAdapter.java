...
public class HandlerAdapter extends AbstractRouterHandler {
            ...
            try {
                ...
                if (field.hasAnnotation(Json.class)) {
                    ...
                    if (value instanceof List) {
                        ...
                        result = this.resolveChildObject(field.getNestedFieldClass(),
     ...
     */
    @SuppressWarnings("unchecked")
    private Object resolveChildObject(Class<?> clazz, Map<String, Object> arguments,
    ...
    @SuppressWarnings("unchecked")
    private void processArgs(Map<String, Object> arguments, Map.Entry<String, String> entry, String key, String k2, String k3) {
