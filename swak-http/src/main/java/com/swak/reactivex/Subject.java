...
public interface Subject {
	 ...
	 */
	void login(HttpServerRequest request, HttpServerResponse response) throws AuthenticationException;
	 ...
	 * @throws AuthenticationException
	 */
	void login(Principal principal, HttpServerRequest request, HttpServerResponse response) throws AuthenticationException;
