...
/**
 * 
 * @Description:abstract mock protocol, it can mock all rpc from server or
 *                       client. implementation class must implement
 *                       'processRequest()' method, and declare SpiMeta
 *                       annotation.
 * @author zhanglei28
 * @date 2016-3-14
 *
