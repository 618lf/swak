...
public class RpcCommandUtil {
	...
	private static class PatternEvaluator {
		...
		Set<Character> all = of('(', ')', '0', '1', '!', '&', '|');
		Map<Character, Set<Character>> following = this.following();

		PatternEvaluator() {
			
		}

        private Map<Character, Set<Character>> following() {
        	Map<Character, Set<Character>> following = new HashMap<>();
        	following.put('(', this.of('0', '1', '!'));
        	following.put(')', this.of('|', '&', ')'));
        	following.put('0', this.of('|', '&', ')'));
        	following.put('1', this.of('|', '&', ')'));
        	following.put('!', this.of('(', '0', '1', '!'));
        	following.put('&', this.of('(', '0', '1', '!'));
        	following.put('|', this.of('(', '0', '1', '!'));
        	return following;
		...
		private Set<Character> of(Character... cs) {
			Set<Character> csSet = new HashSet<>();
			for (Character c : cs) {
				csSet.add(c);
			}
			return csSet;
