...
package com.swak.motan.manager.impl;
...
public class ZookeeperCommandService extends AbstractCommandService implements InitializingBean {
	...
	private String getCommandPath(String groupName) {
		return MotanConstants.ZOOKEEPER_REGISTRY_NAMESPACE + MotanConstants.PATH_SEPARATOR + groupName
				+ MotanConstants.ZOOKEEPER_REGISTRY_COMMAND;
	}
