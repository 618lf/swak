...
public class Hex {
     ...
     * @since 1.4
     */
    public static final String DEFAULT_CHARSET_NAME = StandardCharsets.UTF_8.toString();
	...
	/**
	 * Used to Odd number of characters
	 */
    private static final int ODD_NUMBER = 0x01;
