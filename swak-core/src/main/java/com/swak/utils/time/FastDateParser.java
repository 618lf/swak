...
public class FastDateParser implements DateParser, Serializable {
    ...
    static class TimeZoneStrategy extends PatternStrategy {
        ...
        private static final String GMT_OPTION = GMT_ID + "[+-]\\d{1,2}:\\d{2}";
        ...
        TimeZoneStrategy(final Locale locale) {
            ...
            for (final String[] zoneNames : zones) {
                ...
                if (tzId.equalsIgnoreCase(GMT_ID)) {
                    continue;
                }
        ...
        void setCalendar(final FastDateParser parser, final Calendar cal, final String timeZone) {
            final TimeZone tz = getGmtTimeZone(timeZone);
            if (tz != null) {
                cal.setTimeZone(tz);
            } else {
    ...
    private static class ISO8601TimeZoneStrategy extends PatternStrategy {
        ...
        @Override
        void setCalendar(final FastDateParser parser, final Calendar cal, final String value) {
            cal.setTimeZone(getGmtTimeZone(value));
        }
