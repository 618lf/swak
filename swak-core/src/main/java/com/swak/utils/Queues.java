...
public final class Queues {
	...
	public static <E> ArrayDeque<E> newArrayDeque(Iterable<? extends E> elements) {
		if (elements instanceof Collection) {
			return new ArrayDeque<E>(CollectionUtils.cast(elements));
		}
	...
	public static <E> ConcurrentLinkedQueue<E> newConcurrentLinkedQueue(Iterable<? extends E> elements) {
		if (elements instanceof Collection) {
			return new ConcurrentLinkedQueue<E>(CollectionUtils.cast(elements));
		}
	...
	public static <E> LinkedBlockingDeque<E> newLinkedBlockingDeque(Iterable<? extends E> elements) {
		if (elements instanceof Collection) {
			return new LinkedBlockingDeque<E>(CollectionUtils.cast(elements));
		}
	...
	public static <E> LinkedBlockingQueue<E> newLinkedBlockingQueue(Iterable<? extends E> elements) {
		if (elements instanceof Collection) {
			return new LinkedBlockingQueue<E>(CollectionUtils.cast(elements));
		}
	...
	public static <E extends Comparable> PriorityBlockingQueue<E> newPriorityBlockingQueue(
		...
		if (elements instanceof Collection) {
			return new PriorityBlockingQueue<E>(CollectionUtils.cast(elements));
		}
	...
	public static <E extends Comparable> PriorityQueue<E> newPriorityQueue(Iterable<? extends E> elements) {
		if (elements instanceof Collection) {
			return new PriorityQueue<E>(CollectionUtils.cast(elements));
		}
	...
	/**
	 * Drains the queue as
	 * {@linkplain #drain(BlockingQueue, Collection, int, Duration)}, but with a
	...
	static <T> boolean addAll(Collection<T> addTo, Iterable<? extends T> elementsToAdd) {
		...
		return addAll(addTo, Preconditions.checkNotNull(elementsToAdd).iterator());
	}
