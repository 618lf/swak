 ...
 * @author lifeng
 */
public class RpcServerOptions extends ServerOptions {
	...
	private RpcServerOptions(RpcServerOptions.Builder builder) {
		super(builder);
	...
	public static class Builder extends ServerOptions.Builder {
		 ...
		 * @return
		 */
		public RpcServerOptions build() {
			return new RpcServerOptions(this);
		}
	}
}