...
public class ImageIndicatorView extends RelativeLayout {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.widget_imageindicator, this);
    ...
    protected void refreshIndicateView() {
        ...
        for (int index = 0; index < totelCount; index++) {
            ...
            if (this.currentIndex == index) {
                imageView.setBackgroundResource(R.drawable.widget_imageindicator_focus);
            } else {
                imageView.setBackgroundResource(R.drawable.widget_imageindicator_image_indicator);
            }
        }
