...
public class MemberKits {
    ...
    static boolean isAssignable(Class<?>[] classArray, Class<?>[] toClassArray, final boolean autoboxing) {
        if (ClassKits.isSameLength(classArray, toClassArray) == false) {
            return false;
        }
        if (classArray == null) {
            classArray = ClassKits.EMPTY_CLASS_ARRAY;
        }
        if (toClassArray == null) {
            toClassArray = ClassKits.EMPTY_CLASS_ARRAY;
        }
