...
public class RoundProgress extends View {
	...
	public RoundProgress(Context context, AttributeSet attrs, int defStyle) {
		...
		//获取自定义属性和默认值
		roundColor = mTypedArray.getColor(R.styleable.RoundProgress_roundColor, Color.WHITE);
		roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgress_roundProgressColor, Color.parseColor("#F6B141"));
		textColor = mTypedArray.getColor(R.styleable.RoundProgress_textColor, Color.GREEN);
		textSize = mTypedArray.getDimension(R.styleable.RoundProgress_textSize1, 15);
		roundWidth = mTypedArray.getDimension(R.styleable.RoundProgress_roundWidth, 20);
