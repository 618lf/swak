...
public class TitleView extends FrameLayout {
    ...
    private void initView(final Context context, AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.rx_title_layout, this);

        mRootLayout = (RelativeLayout) findViewById(R.id.root_layout);
        mTvTitle = (TextAutoZoom) findViewById(R.id.tv_rx_title);
        ...
        try {
            ...
            mLeftIcon = a.getResourceId(R.styleable.TitleView_leftIcon, R.drawable.icon_previous);//左边图标
            mRightIcon = a.getResourceId(R.styleable.TitleView_rightIcon, R.drawable.set);//右边图标
            mLeftIconVisibility = a.getBoolean(R.styleable.TitleView_leftIconVisibility, true);//左边图标是否显示
            mRightIconVisibility = a.getBoolean(R.styleable.TitleView_rightIconVisibility, false);//右边图标是否显示
