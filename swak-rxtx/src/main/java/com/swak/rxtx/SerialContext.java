...
import com.swak.rxtx.reader.SerialReader;
...
public class SerialContext {
	...
	private static Set<SerialDataParser> serialDataParserSet = Collections
			.synchronizedSet(new HashSet<SerialDataParser>());

	public static Set<SerialDataProcessor> serialDataProcessorSet = Collections
			.synchronizedSet(new HashSet<SerialDataProcessor>());
