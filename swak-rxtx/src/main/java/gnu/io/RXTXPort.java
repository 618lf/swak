...
public class RXTXPort extends SerialPort {
	 ...
	 * Open the named port
	 * 
	 * @param name the name of the device to open PortInUseException
	 * @see gnu.io.SerialPort
	 */
	 ...
	 * @param d databits
	 * @param s stopbits
	 * @param p parity UnsupportedCommOperationException
	 ...
	 * 
	 * @param f framming UnsupportedCommOperationException
	 */
	...
	*/
	 ...
	 * 
	 * @param lsnr SerialPortEventListener TooManyListenersException
	 */
	...
	*/
	 ...
	 * Extension to CommAPI. Set Baud Base to 38600 on Linux and W32 before using.
	 * 
	 * @param Divisor UnsupportedCommOperationException, IOException
	 */
