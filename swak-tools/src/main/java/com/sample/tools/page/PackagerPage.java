...
import com.sample.tools.config.Version;
import com.sample.tools.operation.OpsFile;
import com.sample.tools.operation.ops.PackOps;
 ...
 * @author lifeng
 */
@FXMLView(title = "开发工具", value = "PackagerPage.fxml", css = { "/css/bootstrapfx.css",
...
public class PackagerPage extends Window {
	...
	public void initialize() {
		this.dirBtn.setOnAction(event -> {
			...
			fileChooser.setTitle("开发工具.选择目录");
