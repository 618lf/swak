...
import com.swak.tools.operation.ops.BackupOps;
import com.swak.tools.operation.ops.PatchOps;
 ...
 * @author lifeng
 */
@FXMLView(title = "深大穿戴.陀螺仪", value = "UpgraderPage.fxml", css = { "/css/bootstrapfx.css",
...
public class UpgraderPage extends Window {
	...
	public void initialize() {
		this.patchBtn.setOnAction(event -> {
			...
			fileChooser.setTitle("深大穿戴.陀螺仪.添加补丁文件");
			fileChooser.setInitialDirectory(initFile);
			fileChooser.setSelectedExtensionFilter(
					new ExtensionFilter("深大穿戴.陀螺仪补丁文件", new String[] { "*.zip", "*.ZIP*" }));
