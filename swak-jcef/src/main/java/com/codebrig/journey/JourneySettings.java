...
/**
 * Functions as a local proxy for CefSettings. Note: This doesn't use a real
 * proxy because CefSettings exposes configuration through fields instead of
 * methods.
 *
...
//    }
	...
	public enum LogSeverity {
		LOGSEVERITY_DEFAULT, LOGSEVERITY_VERBOSE, LOGSEVERITY_INFO, LOGSEVERITY_WARNING, LOGSEVERITY_ERROR,
		LOGSEVERITY_DISABLE;
	}
}
