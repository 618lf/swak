package com.swak.dubbo.annotation;
...
/**
 * 支持和vertx 的桥接<br>
 * An annotation used for referencing a Dubbo service <br>
 *
 * @since 2.7.7
 */
@Documented
...
public @interface DubboReference {
	...
	/**
	 * When enable, prefer to call local service in the same JVM if it's present,
	...
	/**
	 * Cluster strategy, legal values include: failover, failfast, failsafe,
	 * failback, forking
	 */
