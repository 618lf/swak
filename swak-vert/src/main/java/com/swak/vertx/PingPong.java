...
public class PingPong extends SyncVerticle {
	...
	/*
	 * Convenience method so you can run it in your IDE Note if in IDE need to edit
	 * run settings and add:
	 * -javaagent:/home/tim/.m2/repository/co/paralleluniverse/quasar-core/0.7.2/
	 * quasar-core-0.7.2.jar
	 */
