...
(function () {
    ...
    OnlineImage.prototype = {
        ...
        /* 初始化容器 */
        initContainer: function () {
        	var webRoot = parent.webRoot;
        	var html = "<iframe class=\"edui-iframe\" src=\""+webRoot+"/admin/system/attachment/select\" width=\"100%\"></iframe>";
        	...
        	$('.edui-iframe').each(function() {
        		...
        		self.css({
        			height : (function(){
        				return self.closest('#imageList').height() - 5;
        			})()
        		});
        	});
        },
        ...
        getInsertList: function () {
        	var files = $('#imageList').find('.edui-iframe').get(0).contentWindow.THISPAGE.getSelectedFiles();
            var list = [], align = getAlign();
			$.each(files, function (index, node) {
				var src = node.src;
                return list.push({
                    _src: src,
                    src: src,
